...
<head>
    ...
    <link rel="stylesheet" href="/css/theme/default/materialdesignicons.css">
    <link rel="stylesheet" href="/css/theme/default/boxicons.css">
    <link rel="stylesheet" href="/css/theme/default/dripicons.css">
    <link rel="stylesheet" href="/css/theme/default/account.css">
    <link rel="stylesheet" href="/css/theme/default/flow.css">
@stack('styles')
</head>
<body style="background-color: #fff;">
<div class="account-header" style="width: 100%;margin: 0 auto;min-height: 200px">
...
<div id="main-container" class="main container" style="width: 100%; margin-top: -20px">
        <div class="row">
            <div id="page-container" class="sidebar-l sidebar sidebar-mini side-scroll side-overlay sidebar-o" style="padding: 0;">
                @if (session('error'))
...
<script type="module" src="/js/theme/default/account.js"></script>
@stack('scripts')
</body>
</html>
