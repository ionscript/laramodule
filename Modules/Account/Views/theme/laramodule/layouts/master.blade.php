...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        <meta charset="utf-8" />
        <title> @yield('title') | Laramodule</title>
    ...
    <div id="preloader">
        <div id="status">
          ...
          <div id="layout-wrapper">
            @include('account::theme.default.layouts.topbar')
            @include('account::theme.default.layouts.sidebar')
            <!-- ============================================================== -->
            ...
            <!-- End Page-content -->
            @include('account::theme.default.layouts.footer')
            </div>
            <!-- end main content-->
    </div>
    <!-- END layout-wrapper -->
    ...
    <!-- Right Sidebar -->
    @include('account::theme.default.layouts.right-sidebar')
    <!-- /Right-bar -->
